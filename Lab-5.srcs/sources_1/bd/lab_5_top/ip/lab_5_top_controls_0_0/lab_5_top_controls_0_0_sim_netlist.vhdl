...
-- Date        : Thu Apr 25 21:39:59 2019
-- Host        : ece26 running 64-bit Ubuntu 16.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/user/Lab-5/Lab-5.srcs/sources_1/bd/lab_5_top/ip/lab_5_top_controls_0_0/lab_5_top_controls_0_0_sim_netlist.vhdl
-- Design      : lab_5_top_controls_0_0
...
entity lab_5_top_controls_0_0_controls is
  port (
  ...
  attribute ORIG_REF_NAME of lab_5_top_controls_0_0_controls : entity is "controls";
end lab_5_top_controls_0_0_controls;

architecture STRUCTURE of lab_5_top_controls_0_0_controls is
  ...
  signal \reg1Addr[4]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_curr[0]_i_5\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_sequential_curr[0]_i_7\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_sequential_curr[1]_i_6\ : label is "soft_lutpair1";
...
\rID1[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000CCAC0000A0A0"
    )
        port map (
      I0 => p_0_in_0(1),
      I1 => \reg1Addr_reg_n_0_[1]\,
      I2 => curr(1),
      I3 => curr(0),
      I4 => curr(4),
      I5 => curr(2),
...
\rID1_reg[4]_i_1\: unisim.vcomponents.MUXF7
     port map (
      I0 => \rID1[4]_i_3_n_0\,
      I1 => \rID1[4]_i_4_n_0\,
...
\reg1Addr[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30FFAAAA"
    )
        port map (
...
\reg1Addr[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => curr(4),
      I1 => \reg1Addr[4]_i_2_n_0\,
      O => \reg1Addr[4]_i_1_n_0\
    );
\reg1Addr[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"22AA882022888820"
    )
        port map (
      I0 => \reg1Addr[4]_i_4_n_0\,
      I1 => curr(2),
      I2 => \FSM_sequential_curr_reg[4]_i_5_n_2\,
      I3 => curr(1),
      I4 => curr(0),
      I5 => \FSM_sequential_curr_reg[4]_i_4_n_2\,
      O => \reg1Addr[4]_i_2_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity lab_5_top_controls_0_0 is
  port (
    clk : in STD_LOGIC;
    en : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of lab_5_top_controls_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of lab_5_top_controls_0_0 : entity is "lab_5_top_controls_0_0,controls,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of lab_5_top_controls_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of lab_5_top_controls_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of lab_5_top_controls_0_0 : entity is "controls,Vivado 2018.2";
end lab_5_top_controls_0_0;

architecture STRUCTURE of lab_5_top_controls_0_0 is
...
begin
  fbRST <= \<const1>\;
  sendUART <= \<const1>\;
U0: entity work.lab_5_top_controls_0_0_controls
     port map (
