...
################################################################
# This is a generated script based on design: lab_5_top
#
...
# source lab_5_top_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# clock_div_115200, clock_div_25MHz, controls, debounce, framebuffer, my_alu, pixel_pusher, regs, uart, vga_ctrl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: clock_div_115200_0, and set properties
  set block_name clock_div_115200
  set block_cell_name clock_div_115200_0
  if { [catch {set clock_div_115200_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clock_div_115200_0 eq "" } {
  ...
  connect_bd_net -net btn_0_1 [get_bd_ports btn] [get_bd_pins debounce_0/btn]
  connect_bd_net -net clock_div_115200_0_clock_out [get_bd_pins clock_div_115200_0/clock_out] [get_bd_pins controls_0/en] [get_bd_pins framebuffer_0/en1] [get_bd_pins my_alu_0/en] [get_bd_pins regs_0/en] [get_bd_pins uart_0/en]
  connect_bd_net -net clock_div_25MHz_0_clock_out [get_bd_pins clock_div_25MHz_0/clock_out] [get_bd_pins framebuffer_0/en2] [get_bd_pins pixel_pusher_0/en] [get_bd_pins vga_ctrl_0/en]
  connect_bd_net -net clock_in_0_1 [get_bd_ports clk] [get_bd_pins clock_div_115200_0/clock_in] [get_bd_pins clock_div_25MHz_0/clock_in] [get_bd_pins controls_0/clk] [get_bd_pins dMem/clka] [get_bd_pins debounce_0/clk] [get_bd_pins framebuffer_0/clk1] [get_bd_pins irMem/clka] [get_bd_pins my_alu_0/clock] [get_bd_pins pixel_pusher_0/clk] [get_bd_pins regs_0/clk] [get_bd_pins uart_0/clk] [get_bd_pins vga_ctrl_0/clk]
  ...
  connect_bd_net -net controls_0_sendUART [get_bd_pins controls_0/sendUART] [get_bd_pins uart_0/send]
  connect_bd_net -net controls_0_wr_en [get_bd_pins controls_0/wr_en] [get_bd_pins framebuffer_0/wr_en1]
  ...
  connect_bd_net -net my_alu_0_output [get_bd_pins controls_0/aluResult] [get_bd_pins my_alu_0/output]
