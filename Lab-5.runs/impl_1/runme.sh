...
HD_PWD='/home/user/Lab-5/Lab-5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_5_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_5_top_wrapper.tcl -notrace
