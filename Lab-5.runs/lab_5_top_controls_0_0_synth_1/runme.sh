...
HD_PWD='/home/user/Lab-5/Lab-5.runs/lab_5_top_controls_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_5_top_controls_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_5_top_controls_0_0.tcl
